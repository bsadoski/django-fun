...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('example', '0005_auto_20210119_2011'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='person',
            name='age',
            field=models.IntegerField(blank=True, default=False, verbose_name='Idade da pessoa'),
        ),
        migrations.AlterField(
            model_name='person',
            name='first_name',
        ...
        migrations.AlterField(
            model_name='person',
            name='shirt_size',
            field=models.CharField(blank=True, choices=[('S', 'Small'), ('M', 'Medium'), ('L', 'Large')], max_length=1, verbose_name=''),
        ),
        migrations.CreateModel(
            name='Article',
            fields=[
